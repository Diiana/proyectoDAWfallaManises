 ...
 */
package net.fallamanises.control;
...
import net.fallamanises.operaciones.GenericOperation;
...
//        }
        ...
        if (request.getSession().getAttribute("usuarioBean") == null) {
            ...
            try {
                try {
                    GenericOperation operation = (GenericOperation) Class.forName("net.fallamanises.operaciones." + callop).newInstance();
