 ...
 * @author Diana
 */
public class CargoGetregisters implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oCargoDAO.getCount(alFilter);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("CargoGetregistersJson: View Error: " + e.getMessage());
        }
    }
}
