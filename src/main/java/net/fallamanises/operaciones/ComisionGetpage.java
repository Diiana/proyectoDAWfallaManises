 ...
 * @author Diana
 */
public class ComisionGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<ComisionBean> oComisions = oComisionDAO.getPage( rpp, page, alFilter,hmOrder );
            data = new Gson().toJson(oComisions);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
