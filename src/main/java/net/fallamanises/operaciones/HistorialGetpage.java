 ...
 * @author Diana
 */
public class HistorialGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<HistorialBean> oHistorials = oHistorialDAO.getPage( rpp, page, alFilter,hmOrder );
            
            GsonBuilder gsonBuilder = new GsonBuilder();
            gsonBuilder.setDateFormat("dd/MM/yyyy");
            Gson gson = gsonBuilder.create();
            data = gson.toJson(oHistorials);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
