 ...
 * @author Diana
 */
public class HistorialGetregisters implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oHistorialDAO.getCount(alFilter);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("HistorialGetregistersJson: View Error: " + e.getMessage());
        }
    }
}
