 ...
 * @author Diana
 */
public class RecompensaGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<RecompensaBean> oRecompensas = oRecompensaDAO.getPage( rpp, page, alFilter,hmOrder );
            data = new Gson().toJson(oRecompensas);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
