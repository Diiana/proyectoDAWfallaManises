...
var control_recompensa_list = function(path) {
    //contexto privado

    var prefijo_div = "#recompensa_list ";
    ...
    function cargaRecompensa(id) {
        ...
        censoControl.inicia(censoView, 1, null, null, 10, null, null, null, null, "id_recompensa", "equals", id);
        return false;
